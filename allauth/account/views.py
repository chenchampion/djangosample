...
class LoginView(RedirectAuthenticatedUserMixin,
    ...
    template_name = "account/accountlogin." + app_settings.TEMPLATE_EXTENSION
    success_url = "/"
...
class LogoutView(TemplateResponseMixin, View):
    ...
    template_name = "account/accountlogout." + app_settings.TEMPLATE_EXTENSION
    redirect_field_name = "next"
...
def account_profile_detail(
        request,
        template='account/account_profile_detail.html',
        username=None,
        **extra_context
):
...
def account_group_list(
        request,
        template='account/account_group_list.html',
        groupname=None,
        **extra_context
):
    if(groupname):
        user_list = CustomUser.objects.filter(groups__name=groupname)
    else:
        user_list = None

    extra_context['user_list'] = user_list
    extra_context['group_name'] = groupname
    return render(request, template, extra_context)
