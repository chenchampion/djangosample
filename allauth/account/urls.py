...
urlpatterns = [
    ...
    #user profile
    url(r"^profile_deatail/(?P<username>[-\w]+)/$", views.account_profile_detail,name="account-profile-detail"),
    url(r"^profile_group_list/(?P<groupname>[-\w]+)/$", views.account_group_list, name="account-group-list"),
]
