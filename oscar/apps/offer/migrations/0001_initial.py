    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_datetime', models.DateTimeField(blank=True, help_text="Offers are active until the end of the 'end date'", null=True, verbose_name='End date')),
                ...
                ('benefit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offer.Benefit', verbose_name='Benefit')),
                ('condition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='offer.Condition', verbose_name='Condition')),
            ],
            options={
                'ordering': ['-priority'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(b'Pending', b'Pending'), (b'Failed', b'Failed'), (b'Processed', b'Processed')], default=b'Pending', max_length=32, verbose_name='Status')),
