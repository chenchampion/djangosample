...
Unavailable = get_class('investor.availability', 'Unavailable')
Available = get_class('investor.availability', 'Available')
StockRequiredAvailability = get_class('investor.availability', 'StockRequired')
UnavailablePrice = get_class('investor.prices', 'Unavailable')
FixedPrice = get_class('investor.prices', 'FixedPrice')
TaxInclusiveFixedPrice = get_class('investor.prices', 'TaxInclusiveFixedPrice')
