...
class InvestorDetailView(DetailView):
    ...
    template_folder = "investor"
    template_name = 'investor/detail.html'
    ...
    def get(self, request, **kwargs):
        ...
        response = super(InvestorDetailView, self).get(request, **kwargs)
    ...
    def get_object(self, queryset=None):
        ...
        if hasattr(self, 'object'):
            ...
            return super(InvestorDetailView, self).get_object(queryset)
    ...
    def get_context_data(self, **kwargs):
        ctx = super(InvestorDetailView, self).get_context_data(**kwargs)
...
class CatalogueView(TemplateView):
    ...
    template_name = 'investor/browse.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx[self.context_object_name] = Investor.objects.all()
        #ctx.update(search_context)
        return ctx


class InvestorCategoryView(TemplateView):
    """
    ...
    def get(self, request, *args, **kwargs):
        ...
        return super(InvestorCategoryView, self).get(request, *args, **kwargs)
    ...
    def get_category(self):
        if 'pk' in self.kwargs:
            ...
            return get_object_or_404(Investor, pk=self.kwargs['pk'])
            ...
            slugs = concatenated_slugs.split(Investor._slug_separator)
            try:
                last_slug = slugs[-1]
            except IndexError:
                raise Http404
            else:
                for category in Investor.objects.filter(slug=last_slug):
    ...
    def get_context_data(self, **kwargs):
        context = super(InvestorCategoryView, self).get_context_data(**kwargs)
