...
class Note(models.Model):
    ...
    content_type = models.ForeignKey(ContentType, verbose_name=_('content type'), related_name='content_type')
...
class EventType(models.Model):
    ...
    point_person = models.ForeignKey(CustomUser, default="", blank=True, null = True, related_name='point_person')
    users = models.ManyToManyField(
        CustomUser, related_name='user_projects1', blank=True)
    related_group = models.ManyToManyField(
        Group, related_name='related_group1',
        blank=True)
    status = models.CharField(_('Project Status'), max_length=50, blank=True)
    description = models.TextField(blank=True)

    @models.permalink
    def get_absolute_url(self):
        return ('event-types-detail', [str(self.abbr)])
...
class Event(models.Model):
    ...
    event_type = models.ForeignKey(EventType, verbose_name=_('event type'), null=True)
    notes = GenericRelation(Note, verbose_name=_('notes'))
    user = models.ForeignKey(CustomUser, related_name='event_user', null=True, blank=True)
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('dashboard:event-detail', [str(self.id)])
...
class Occurrence(models.Model):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('dashboard:dashboard-occurrence', [str(self.event.id), str(self.id)])
