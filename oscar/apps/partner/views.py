...
class PartnerDetailView(DetailView):
    ...
    def get(self, request, **kwargs):
        ...
        response = super(PartnerDetailView, self).get(request, **kwargs)
    ...
    def get_object(self, queryset=None):
        ...
        if hasattr(self, 'object'):
            ...
            return super(PartnerDetailView, self).get_object(queryset)
...
class CatalogueView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx[self.context_object_name] = Partner.objects.all()
        #ctx.update(search_context)
        return ctx


class PartnerCategoryView(TemplateView):
    """
    ...
    def get(self, request, *args, **kwargs):
        ...
        return super(PartnerCategoryView, self).get(request, *args, **kwargs)
    ...
    def get_category(self):
        if 'pk' in self.kwargs:
            ...
            slugs = concatenated_slugs.split(Partner._slug_separator)
            try:
                last_slug = slugs[-1]
            except IndexError:
                raise Http404
            else:
                for category in Partner.objects.filter(slug=last_slug):
    ...
    def get_context_data(self, **kwargs):
        context = super(PartnerCategoryView, self).get_context_data(**kwargs)
