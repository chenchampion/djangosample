...
class AbstractCompanyAddress(AbstractAddress):
    """
...
class AbstractInvestorAddress(AbstractAddress):
    """
    A investor can have one or more addresses. This can be useful e.g. when
    determining US tax which depends on the origin of the shipment.
    """
    ...
    class Meta:
        abstract = True
        app_label = 'investor'
        verbose_name = _("Investor address")
        verbose_name_plural = _("Investor addresses")