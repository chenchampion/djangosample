    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[(b'Bestselling', 'Bestselling products'), (b'RecentlyAdded', 'Recently added products')], max_length=128, verbose_name='Method')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clicks', models.PositiveIntegerField(default=0, verbose_name='Clicks')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Date Created')),
                ('page_url', oscar.models.fields.ExtendedURLField(db_index=True, max_length=128, verbose_name='Page URL', verify_exists=True)),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
            options={
                'ordering': ['-clicks'],
