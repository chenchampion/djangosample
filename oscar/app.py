...
class Shop(Application):
    ...
    company_app = get_class('company.app', 'application')
    investor_app = get_class('investor.app', 'application')
    ...
    def get_urls(self):
        urls = [
            ...
            url(r'^partner/', self.partner_app.urls),
            url(r'^company/', self.company_app.urls),
            url(r'^investor/', self.investor_app.urls),
