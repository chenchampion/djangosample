...
@register.inclusion_tag('partner/vendor_products.html',
                        takes_context=True)
def recently_viewed_products(context, current_partner=None):
    """
    Inclusion tag listing the most recently viewed products
    """
    request = context['request']
    products = Product.objects.filter(partner__name=current_partner.name)
